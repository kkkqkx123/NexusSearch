...
### warning: unnecessary map of the identity function: help: remove the call to `map`
...
- Line 64: field assignment outside of initializer for an instance created with Default::default()
